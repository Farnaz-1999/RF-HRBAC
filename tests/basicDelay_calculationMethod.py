...
def FRHRBAC_api_test(api_address:str,method:str,msg:str,params:str=""):
...
def FRHRBAC_performance_test(n_times:int,api_address:str,method:str,msg:str,params:str=""):
    result=0
    for i in range(n_times):
        result+=FRHRBAC_api_test(api_address,method,msg,params)
